...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (!$setup.isQuizStarted) {
    _push(`<div class="max-w-2xl mx-auto"><div class="card text-center"><h2 class="text-2xl font-heading font-bold text-gray-900 mb-6"> Choose Your Quiz Settings </h2><div class="mb-6"><label class="block text-sm font-medium text-gray-700 mb-3"> Select Category </label><select class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-primary focus:border-primary"><option value=""${ssrIncludeBooleanAttr(Array.isArray($setup.selectedCategory) ? ssrLooseContain($setup.selectedCategory, "") : ssrLooseEqual($setup.selectedCategory, "")) ? " selected" : ""}>All Categories (Mixed Quiz)</option><!--[-->`);
