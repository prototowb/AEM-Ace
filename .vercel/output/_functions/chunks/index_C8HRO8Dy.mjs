import { l as getDefaultExportFromCjs, n as commonjsGlobal } from './astro/server_DeWV9nz_.mjs';
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    operatorsExports.combineLatestWith(
      cjsExports.from(
        import('./stegaEncodeSourceMap_BF7YiqPw.mjs').then(function(n) {
...
const pick = (obj, props) => props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}), eventSourcePolyfill = cjsExports.defer(() => import('./node_DGsCYuPx.mjs').then(n => n.n)).pipe(
