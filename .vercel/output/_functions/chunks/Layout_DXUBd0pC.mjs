import { e as createComponent, f as createAstro, r as renderTemplate, l as renderSlot, n as renderHead, h as addAttribute } from './astro/server_B4bmrHlw.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                           */
...
Built with Astro, Vue, and Tailwind CSS
    ...
    <\/script> </body> </html>`])), addAttribute(description, "content"), title, renderHead(), renderSlot($$result, $$slots["default"]));
